      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-rose-500 to-purple-600 bg-clip-text text-transparent">
          ...
          <Card className="p-8 bg-white/80 backdrop-blur-sm border-rose-100 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="restaurantName" className="text-rose-700 font-medium">
                  Restaurangens namn *
                </Label>
                <Input
                  id="restaurantName"
              ...
              <div className="space-y-2">
                <Label htmlFor="contactPerson" className="text-rose-700 font-medium">
                  Kontaktperson *
                </Label>
                <Input
                  id="contactPerson"
              ...
              <div className="space-y-2">
                <Label htmlFor="location" className="text-rose-700 font-medium">
                  Plats / Ort *
                </Label>
                <Input
                  id="location"
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="ja" className="text-gray-700">Ja</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="nej" id="nej" />
                    <Label htmlFor="nej" className="text-gray-700">Nej</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="osaeker" id="osaeker" />
                    <Label htmlFor="osaeker" className="text-gray-700">Osäker</Label>
                  </div>
                </RadioGroup>
              </div>

              <div className="space-y-2">
                <Label htmlFor="additional" className="text-rose-700 font-medium">
                ...
                <Textarea
                  ...
                  className="border-rose-200 focus:border-rose-400 min-h-[120px]"
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full bg-gradient-to-r from-rose-500 to-purple-600 hover:from-rose-600 hover:to-purple-700 text-white py-4 text-lg font-medium"
              >

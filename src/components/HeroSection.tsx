      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-12 sm:mb-16 px-4">
            <Button 
              size="lg"
              className="w-full sm:w-auto bg-gradient-to-r from-rose-500 to-purple-600 hover:from-rose-600 hover:to-purple-700 text-white px-6 sm:px-8 py-4 text-base sm:text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 min-h-[44px]"
            ...
            <Button 
              size="lg"
              variant="outline"
              className="w-full sm:w-auto border-2 border-rose-300 text-rose-600 hover:bg-rose-50 px-6 sm:px-8 py-4 text-base sm:text-lg transition-all duration-300 transform hover:scale-105 min-h-[44px]"
